...
//			pw.println("Specified directory is not present");
		...
		pw.println("Lines " + lines + " characters " +chars+ " words " +words);
	}
...
//			
	...
	private static void mkdir(PrintWriter pw, String string) {
	...
	private static void touch(PrintWriter pw, String string) throws IOException {
		File f = new File(string);
		f.createNewFile();
